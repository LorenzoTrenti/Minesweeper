...
def inizializza(size, rows, cols):
    ...
    bandiera = pg.image.load("C:/Users/loren/Documents/Creo_giochi/Campo Minato/Images/flag.png")
    bomba = pg.image.load("C:/Users/loren/Documents/Creo_giochi/Campo Minato/Images/bomb.png")
...
def controllo_vittoria(controllo, tabella, rows, cols):
    ...
    return vittoria
def hai_perso():
    lose_sup, lose_rect = centra_testo(lose, "red", 3, 50)
    lose_rect.center=(WIDTH-(distanza_width/2), HEIGHT/2)
    screen.blit(lose_sup, lose_rect)

def hai_vinto():
    victory_sup, victory_rect = centra_testo(victory, "yellow", 3, 50)
